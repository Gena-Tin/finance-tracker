...
function App() {
  ...
  // Уточняем, что урл — это строка (на случай, если конфиг затупит)
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      category_id: Number(catId), // Убедимся, что на бэк уйдет число
      id: editingId ?? undefined, // Если null, на бэк не шлем поле id
    ...
    try {
      // Передаем id или null (хук useTransactions должен это переварить)
              ...
              >
                <ToolsSection
                  ...
                  formProps={{
                    ...
                    categories,
                    projects,
                    handleSubmit: handleSubmit as any, // Смягчаем типизацию ивента для пропса
                    isSubmitting,
